        ...
        <div class="standard-card">
            <div class="card-header-styled mb-4">
                <h5 class="card-title-styled">
                    ...
                    <span>Department Specifications (Code: <?php echo htmlspecialchars($dept['code']); ?>)</span>
                </h5>
            </div>

            <form method="POST" action="<?php echo base_url('departments/edit/' . $dept['id']); ?>" class="row g-3">
                <!-- 1. Department Code -->
                <div class="col-12 col-sm-6">
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo set_value('code', $dept['code']); ?>"
                           required>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo set_value('name', $dept['name']); ?>"
                           required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control input-custom" 
                              ...
                              name="description" 
                              rows="3" 
                              placeholder="Add brief details about the department services..."><?php echo set_value('description', $dept['description']); ?></textarea>
                </div>
