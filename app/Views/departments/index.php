...
<div class="modal fade" id="createDeptModal" tabindex="-1" aria-labelledby="createDeptModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            ...
            <!-- Form -->
            <form method="POST" action="<?php echo base_url('departments/create'); ?>">
...
<?php if (!empty($departments)): ?>
    ...
    <div class="modal fade" id="editDeptModal-<?php echo $dept['id']; ?>" tabindex="-1"
         aria-labelledby="editDeptModalLabel-<?php echo $dept['id']; ?>" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-header border-bottom px-4" style="padding-top: 1.1rem; padding-bottom: 1.1rem;">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h5 class="modal-title fw-bold mb-0" id="editDeptModalLabel-<?php echo $dept['id']; ?>"
                            style="color: #1e293b; font-size: 1.25rem; letter-spacing: -0.01em;">
                            Edit Department
                        </h5>
                    </div>
                ...
                <!-- Form -->
                <form method="POST" action="<?php echo base_url('departments/edit/' . $dept['id']); ?>">
                    <div class="modal-body px-4 py-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   class="form-control input-custom"
                                   id="edit_dept_name_<?php echo $dept['id']; ?>"
                                   name="name"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var el = document.getElementById('editDeptModal-<?php echo $dept['id']; ?>');
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var el = document.getElementById('createDeptModal');
        if (el) { new bootstrap.Modal(el).show(); }
    });
</script>
<?php endif; ?>
